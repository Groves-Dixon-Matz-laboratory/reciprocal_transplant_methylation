...
plot(d$gbm~d$ge, col = alpha('black', 0.01), pch=1, cex=0.75, xlim=c(-1, 10), ylim=c(-1, 10), xlab="Normalized Counts (Tag-seq)", ylab="Normalized Counts (MBD-seq)")
lm1=lm(d$gbm~d$ge)
summary(lm1)
text(x=0, y=10, "R2=0.03****")
