...
#args:
	# 20 = the soft threshold
	# 30 = minimum module size
	# 0 = merging threshold
	# wgcna-01_output.RData = input
	# signed = use singed network (rather than unsigned)



#parse arguments
args = commandArgs(trailingOnly=TRUE)
softPower = as.integer(args[1])
minModuleSize = as.integer(args[2])
MEDissThres = as.numeric(args[3])
input = args[4]
NETWORK.TYPE = args[5]
...
save(MEs, moduleLabels, moduleColors, geneTree, file = outName)
