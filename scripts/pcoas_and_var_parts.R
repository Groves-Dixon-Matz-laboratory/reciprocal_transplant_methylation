#pcoas_and_var_parts.R
#plot partitioning of variance pie charts and PcoAs for gene expression and gene body methylation

#--------------------- load the DESeq outputs ------------#
#for gene expression
library(vegan)
...
#---------- plot partitioning of variance piecharts ----------#
#for gene expression
...
vsds=vsd[!is.na(home.r$pvalue) & home.r$pvalue < 0.01 , ]
coo=conditions
str(vsds)
dim(vsds)
invert=-1
