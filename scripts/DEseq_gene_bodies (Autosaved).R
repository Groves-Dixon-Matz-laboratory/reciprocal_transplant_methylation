...
lnames=load("datasets/gbm_counts_p-1000_200.Rdata") #version mapped only to CDS regions
lnames=load("datasets/gbm_counts_FULLGENE.Rdata") #version mapped only to CDS regions
