...
setwd("~/gitreps/reciprocal_transplant_methylation/go_mwu")
...
gomwuStats(input, goDatabase, goAnnotations, goDivision,
	...
	smallest=5,   # a GO category should contain at least this many genes to be considered   default=5
	clusterCutHeight=0.25, # threshold for merging similar (gene-sharing) terms. See README for details. default = .25
